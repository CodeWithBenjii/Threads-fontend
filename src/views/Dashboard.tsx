    ...
    return (
        <div className="dashboard-content">
            <div className="create-post">
                <img src="https://avatars.githubusercontent.com/u/69630292?" alt="" />
                <textarea rows={1} type="text" placeholder="Start a thread..."></textarea>
                <button button-type="post-submit">Post</button>
            </div>
            <div className="thread-feed">
                {DummyPost.map(a => <ThreadPost key={a.id} ThreadAuthorUrl={a.ThreadAuthorUrl} ThreadAuthorAvatar={a.ThreadAuthorAvatar} ThreadAuthorUsername={a.ThreadAuthorUsername} TheadBody={a.TheadBody} ThreadReplys={a.ThreadReplys} ThreadPostTime={a.ThreadPostTime} />)}
            </div>
        </div>
    )
}
